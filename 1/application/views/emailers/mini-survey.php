  ...
  <section style="width: 600px; margin:0 auto;">
    <div style="border:0;">
      <div style="text-align:center;">
        <img src="https://storage.googleapis.com/hqemailerimg/10.png" alt="" width="100%;">
      </div>
      <div style="padding: 0px 25px 0px;">
        <div style="padding:10px 0">
          ...
          <p style="margin:0 0 15px 0;">
            Hello there! </p>
          <p style="margin:0 0 15px 0;">
            To send across a mini survey to your employees, here's what you need to do: </p>
          <div style="margin:0 0 30px 0;">
            ...
            <div style="margin:0 0 15px 0;">
              <p> <b>Step 2-Filling in the details</b>
              </p>
              <p>Name your Mini Survey.</p>
              <p>Add a description about it. This will go in the mail that goes out to the employees. So, start the description by writing 'This survey is about...'</p>
            ...
            <div style="margin:0 0 15px 0;">
              <p>
                <b>Step 3-Uploading employee data</b>
              </p>
